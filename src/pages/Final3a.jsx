...
/* /final3a — revamped landing page, Variant A2 (directed search hero).
   Built around the core promise + 7 pillars. /final2a is left untouched. */
export default function Final3a() {
  useEffect(() => { window.scrollTo(0, 0); }, []);
  return (
    <div className="v3">
      <a href="#v3-main" className="v3-skip">Skip to main content</a>
      <V3Header brandLink="/final3a" />
      <main id="v3-main" tabIndex={-1}>
        <HeroV3 />
        <PathRouter variant="A2" />
        <TrustBar />
        <DestinationMosaic />
        <HowWeTravel />
        <Difference />
