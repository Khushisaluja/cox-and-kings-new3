...
/* ============================================================
   ...
   sourced trust credentials, "Discover my mood" section, Einaya AI.
  ...
  return (
    ...
    <div className="lx2i">
      ...
      <div className="lx2i-thumbbar">
        ...
        <button className="lx2i-thumbbar__ai" aria-label="Open Einaya, the AI travel assistant" onClick={() => setChatOpen(true)}>
          <Sparkles size={20} />
        </button>
      </div>
    ...
    {/* AI chat (Einaya) — rendered OUTSIDE .lx2i so the page's scoped colour/
        font styles can't bleed into the widget. Same working concierge as
        /final2a-stack-ds; launched by this page's "Ask Einaya" buttons. */}
