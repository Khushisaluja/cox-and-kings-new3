...
import {
  Search, Phone, X, ChevronDown, ChevronRight, ChevronLeft, ArrowRight, Star, ZoomIn,
    ...
    <div className="nh">
      ...
      <header className="nh-header">
        ...
        <div className="nh-utility">
          <div className="nh-utility__inner">
            <Link to="/final" className="nh-logo" aria-label="Cox & Kings home">
      ...
      <section className="nh-insp">
        <div className="nh-container nh-insp__head nh-reveal">
          ...
          <a href="#reviews" className="nh-insp__explore">EXPLORE <ArrowRight size={15} /></a>
        </div>
        <div className="nh-container nh-insp__grid nh-reveal">
          {insights.map((a) => (
            <a href="#reviews" key={a.title} className="nh-inspcard">
