...
import {
  ...
  HeartPulse, BedDouble, CloudLightning, Gavel, Scale,
} from 'lucide-react';
...
/* ============================================================
   ...
   VARIANT 3. Route: /tour-detail-japan-3.
   Builds on VARIANT 2 (split itinerary with a day-following picture)
   and reworks the terms section into "The policies": three
   filterable categories — Booking Terms, Cancellation Policy and
   Terms & Conditions — each topic showing a summary + a couple of
   preview points, with the full detail expanding on demand, plus a
   search across every policy.
   ============================================================ */
...
export default function JapanTourLuxe3() {
  ...
  return (
    <>
      <div className="lx2i lxjt lxjt2 lxjt3">
            ...
            <div className="lxjt-tc__panel">
              <div className="lxjt-tc__head">
                <div>
                  ...
                  <h3 className="lxjt-tc__title">{activeCat.label} — Splendours of Japan</h3>
                </div>
